...
public class studyManager : MonoBehaviour
{
    ...
    public List<StudyItem> expandedObjectCollectionItems = new List<StudyItem>();
    ...
    {
        Debug.Log("Assigning coins at start...");
        // create 20 copies of each coin in objectCollectionItems
        // foreach (var item in objectCollectionItems)
        // {
        //     for (int i = 0; i < 20; i++)
        //     {
        //     StudyItem copy = new StudyItem
        //     {
        //         item = item.item,
        //         wimItem = item.wimItem,
        //         environmentIndex = item.environmentIndex,
        //         worldTarget = item.worldTarget,
        //         originalParent = item.originalParent,
        //         originalPosition = item.originalPosition,
        //         originalRotation = item.originalRotation
        //     };
        //     expandedObjectCollectionItems.Add(copy);
        //     }
        // }



        // objectCollectionItems = expandedObjectCollectionItems.ToArray();
    ...
    private void SetUpStudyBlock() {
        ...
        // if it is in demo mode, do not reset the current technique.
    ...
    public void TurnOffTrialBlockStartItem() {
        trialBlockStartItem.item.SetActive(false);
    }
    ...
    {
        // if not demo mode, do task end procedures
        if (StudyConfigurationManager.Instance.CurrentOperationMode != StudyConfigurationManager.OperationMode.Demo)
        {
...
//         // int chosenIndex = candidateIndices[UnityEngine.Random.Range(0, candidateIndices.Count)];
//         int chosenIndex = candidateIndices[UnityEngine.Random.Range(0, 14)];
//         lastEnvironment = activeItems[chosenIndex].environmentIndex;

//         if (activeItems[chosenIndex].item != null)
//         {
//             activeItems[chosenIndex].item.SetActive(true);
//             // activeItems[chosenIndex].item.GetComponent<>().Reset();
//             if (activeItems[chosenIndex].wimItem != null) {
//                 activeItems[chosenIndex].wimItem.SetActive(true);
//             }
