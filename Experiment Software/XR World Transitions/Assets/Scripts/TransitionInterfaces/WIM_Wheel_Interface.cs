...
public class WIM_Wheel_Interface : TransitionInterface
{
    ...
    [SerializeField] private ObjectClipperController objectClipperController;
    ...
    private void positionInterface() {
        ...
        // scale the WIMs
        objectClipperController.sphereRadius = distanceMultiplier * distanceBetweenHands * .1f;
