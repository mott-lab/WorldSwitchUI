...
public class Palette_HandPreview_HandInteraction : InteractionHandler
{
    ...
    void OnEnable()
    {
        DominantHandActivation = false; // non-dominant hand does activation gesture
    }
    ...
    public override void ActivationGestureDetected()
    {
        ...
        Debug.Log("Palette_HandPreview_HandInteraction: Activation Gesture Detected.");
